...
class Perifericos extends Controller
{
    ...
    {
        $data['title'] = 'Perifericos';
        $data['categorias'] = $this->model->getCategorias();
        $data['sedes'] = $this->model->getSedes();
        $data['areas'] = $this->model->getAreas();
        $this->views->getView('admin/perifericos', "index", $data);
    }

    public function listar()
    {
        $data = $this->model->getPeriferico(1);
    ...
    public function registrar()
    {
        if (isset($_POST['categoria'])) {
            ...
            $ruta = 'assets/images/perifericos/';
    ...
    {
        if (is_numeric($idEqu)) {
            $data = $this->model->getPerifericos($idEqu);
    ...
    {
        $id = $_POST['idperifericos'];
        $folder_name = 'assets/images/perifericos/' . $id . '/';
        if (!empty($_FILES)) {
    ...
    public function verGaleria($id_perifericos)
    {
        $result = array();
        $directorio = 'assets/images/perifericos/' . $id_perifericos;
    ...
    public function eliminarImg()
    {
        ...
        $destino = 'assets/images/perifericos/' . $json['url'];
        if (unlink($destino)) {
