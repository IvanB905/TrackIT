...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#listaEquipo" type="button" role="tab" aria-controls="listaEquipo" aria-selected="true">Etiquetadora</button>
    </li>
    <li class="nav-item" role="presentation">
...
<script src="<?php echo BASE_URL . 'assets/js/modulos/etiquetadora.js'; ?>"></script>
