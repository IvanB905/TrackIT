...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#listaEquipo" type="button" role="tab" aria-controls="listaEquipo" aria-selected="true">Perifericos</button>
    </li>
    <li class="nav-item" role="presentation">
            ...
            <div class="card-body p-5">
                <form id="frmRegistro">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group mb-2">
                                <label class="form-label" for="Usuario_Equipo">Usuario Equipo</label>
                                <input id="Usuario_Equipo" class="form-control" type="text" name="Usuario_Equipo" placeholder="Usuario_Equipo">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group mb-2">
...
<script src="<?php echo BASE_URL . 'assets/js/modulos/perifericos.js'; ?>"></script>
